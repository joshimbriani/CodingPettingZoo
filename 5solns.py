...
# If they enter the name of your favorite celebrity return a happy message otherwise print a sad message
# The tricky part is that we want to keep a counter ariables that gets added to whenever the user enters an incorrect name
# When the count hits 5 have mercy on them and return the right answer!
def celebChecker():
    counter = 0
    while counter < 5:
        temporaryVariable = input("What's your favorite celebrity? ")
        if temporaryVariable == "Taylor Swift":
            return "You got it, she's the best!"
        else:
            counter = counter + 1
            print("Hmmm. Not quite, try again!")
    return "The answer was Taylor Swift!"